/**
 * `Account` Page for the Weather Dress App
        ...
        return (
            <div className="wrapper">
                <div className="row col-sm-12">
                    <h3>
                        Account<br />
                        <em className="small text-muted">User Profile</em>
                    </h3>
                </div>
                <hr />
                        ...
                        <CardGroup>
                            ...
                            <Card className="text-white bg-primary py-5 d-md-down-none" style={{ width: '44%' }}>
                                <CardBody className="text-center">
                                    <div>
                                        <h2>Sign up</h2>
                                        <p> Using Weather Dress App for the first time? Create an account here to
                                            fully enjoy all the available features that it offers.</p>
